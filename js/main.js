...
function headerMenu() {
    ...
    menu.addEventListener("click", (event) => {
        ...
        window.innerWidth <= menuCollapseBreakpoint) {
            ...
            // collaspe the other expanded menu-item if exists
...
function themeGlassEffect() {
    const glassEffectChekbox = document.querySelector(".js-glass-effect"),
    glassStyle = document.querySelector(".js-glass-style");

    glassEffectChekbox.addEventListener("click", function() {
        if(this.checked) {
    ...
    if(!glassStyle.hasAttribute("disabled")) {
        glassEffectChekbox.checked = true;
    }
}
